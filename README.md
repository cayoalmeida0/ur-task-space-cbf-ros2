...
> **Estado atual — revisão experimental 0.6.11:** infraestrutura Docker `0.2.0`,
> `ur_cbf_bringup` `0.3.11` e `ur_cbf_control` `0.6.11`. O QP já aceita a primeira
...
> `z=0,027 m` em `c22` e `z=0,025 m` em `c23`, usa `x=y=0; z=0,050 m`
> em `c31`, `x=0; y=0,025 m` em `c32`, `z=0,010 m` em `c41`, preserva
> `z=0` em `c42` e `c51`, e usa `z=-0,018 m` em `c52`, além da cápsula RG2.
