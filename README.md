...
> **Estado atual — revisão experimental 0.6.5:** infraestrutura Docker `0.2.0`,
> `ur_cbf_bringup` `0.3.5` e `ur_cbf_control` `0.6.5`. O QP já aceita a primeira
...
> ensaio atual zera `z` em `c21`, `c22`, `c23` e `c52` e mantém a cápsula RG2.
