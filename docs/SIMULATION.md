...
- 13 objetos do braço derivados da fábrica UAIbot fixada; o ensaio `0.6.6`
  mantém tipos e dimensões, usa `z=0,025 m` em `c21/c22/c23`, `z=0` em `c31`,
  `y=0` em `c32` e restaura `c52` à pose original;
