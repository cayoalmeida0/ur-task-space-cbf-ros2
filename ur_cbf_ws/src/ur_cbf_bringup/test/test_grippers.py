...
def test_uaibot_visual_primitives_preserve_converted_origins_and_sizes():
    ...
    expected = {
        ...
        "c21": ("sphere", "forearm_link", "0 0 0.02", None, "0.05", None),
        "c22": ("cylinder", "forearm_link", "-0.1046 0 0.0225", "-1.570796326795 0 1.570796326795", "0.04", "0.2"),
        ...
        "c32": ("cylinder", "wrist_1_link", "0 0 -0.0011", "-1.570796326795 0 -3.14159265359", "0.035", "0.045"),
