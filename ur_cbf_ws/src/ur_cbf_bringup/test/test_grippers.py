...
def test_uaibot_visual_primitives_preserve_converted_origins_and_sizes():
    ...
    expected = {
        ...
        "c21": ("sphere", "forearm_link", "-0.0246 0 0", None, "0.05", None),
        "c22": ("cylinder", "forearm_link", "-0.1046 0 0", "-1.570796326795 0 1.570796326795", "0.04", "0.2"),
        "c23": ("cylinder", "forearm_link", "-0.2146 0 0", "0 0 1.570796326795", "0.035", "0.09"),
        ...
        "c52": ("cylinder", "wrist_3_link", "0.0011 -0.021 0", "1.570796326795 1.570796326795 0", "0.01", "0.028"),
    }
