"""Contrato versionado da geometria de colisao UR3e do UAIbot 1.2.7."""
...
class UaibotCollisionModelError(RuntimeError):
    """Indica divergencia entre o wheel instalado e o modelo visual fixado."""


@dataclass(frozen=True)
class UaibotPrimitiveSpec:
    """Primitiva, pose no frame DH e dimensoes declaradas pela fabrica."""
...
def validate_uaibot_ur3e_collision_model(robot: Any) -> None:
    """Recusa um modelo UAIbot que nao coincida com o Xacro versionado."""
    ...
    if actual_counts != expected_counts:
        raise UaibotCollisionModelError(
            "Contagem de primitivas UAIbot diverge do Xacro: "
